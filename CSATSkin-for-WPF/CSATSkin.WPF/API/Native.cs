...
namespace CSATSkin
{
    ...
    public static class NativeMethods
    {
        ...
        [DllImport("user32.dll")]
        public static extern int SenCSATessage(IntPtr hwnd, int wMsg, IntPtr wParam, IntPtr lParam);

        [DllImport("user32.dll")]
        public static extern int SenCSATessage(IntPtr hwnd, int msg, int wparam, POINTS pos);
