...
namespace CSATSkin.WPF
{
    ...
    /// 双层双体
    /// </summary>
    public partial class CSATSkinComplexWindow : Window
    {
        #region 初始化
        public CSATSkinComplexWindow()
        {
        ...
        public int CSATWindowShadowSize
        {
            get
            {
                if (_shadowWindow != null)
                {
                    return _shadowWindow.CSATWindowShadowSize;
                }
                else
                {
            ...
            set
            {
                if (_shadowWindow != null)
                {
                    _shadowWindow.CSATWindowShadowSize = value;
                }
                else
                {
        ...
        public Color CSATWindowShadowColor
        {
            get
            {
                if (_shadowWindow != null)
                {
                    return _shadowWindow.CSATWindowShadowColor;
                }
                else
                {
            ...
            set
            {
                if (_shadowWindow != null)
                {
                    _shadowWindow.CSATWindowShadowColor = value;
                }
                else
                {
        ...
        public Brush CSATWindowShadowBackColor
        {
            get
            {
                if (_shadowWindow != null)
                {
                    return _shadowWindow.CSATWindowShadowBackColor;
                }
                else
                {
            ...
            set
            {
                if (_shadowWindow != null)
                {
                    _shadowWindow.CSATWindowShadowBackColor = value;
                }
                else
                {
