...
namespace CSATSkin.WPF
{
    ...
    /// 单层窗体
    /// </summary>
    public partial class CSATSkinSimpleWindow:Window
    {
        #region 初始化
        public CSATSkinSimpleWindow()
        {
        ...
        {
            ResourceDictionary dic = new ResourceDictionary { Source = new Uri(@"/CSATSkin.WPF;component/Styles/CSATSkinSimpleWindow.xaml", UriKind.Relative) };
            Resources.MergedDictionaries.Add(dic);
            Style = (Style)dic["MainWindow"];

            //string packUriAnimation = @"/CSATSkin.WPF;component/Themes/Animation.xaml";
        ...
        #region 窗体属性
        [Description("全屏是否保留任务栏显示"), Category("CSATSkin")]
        public bool CSATFullScreen
        {
            get { return (bool)GetValue(CSATFullScreenProperty); }
            set { SetValue(CSATFullScreenProperty, value); }
        }
        public static readonly DependencyProperty CSATFullScreenProperty =
            DependencyProperty.Register("CSATFullScreen", typeof(bool), typeof(CSATSkinSimpleWindow), new PropertyMetadata(false));

        [Description("窗体阴影大小"), Category("CSATSkin")]
        public int CSATWindowShadowSize
        {
            get { return (int)GetValue(CSATWindowShadowSizeProperty); }
            set { SetValue(CSATWindowShadowSizeProperty, value); }
        }
        public static readonly DependencyProperty CSATWindowShadowSizeProperty =
            DependencyProperty.Register("CSATWindowShadowSize", typeof(int), typeof(CSATSkinSimpleWindow), new PropertyMetadata(10));

        [Description("窗体阴影颜色"), Category("CSATSkin")]
        public Color CSATWindowShadowColor
        {
            get { return (Color)GetValue(CSATWindowShadowColorProperty); }
            set { SetValue(CSATWindowShadowColorProperty, value); }
        }
        public static readonly DependencyProperty CSATWindowShadowColorProperty =
            DependencyProperty.Register("CSATWindowShadowColor", typeof(Color), typeof(CSATSkinSimpleWindow), new PropertyMetadata(Color.FromArgb(255, 200, 200, 200)));

        [Description("窗体阴影透明度"), Category("CSATSkin")]
        public double CSATWindowShadowOpacity
        {
            get { return (double)GetValue(CSATWindowShadowOpacityProperty); }
            set { SetValue(CSATWindowShadowOpacityProperty, value); }
        }
        public static readonly DependencyProperty CSATWindowShadowOpacityProperty =
            DependencyProperty.Register("CSATWindowShadowOpacity", typeof(double), typeof(CSATSkinSimpleWindow), new PropertyMetadata(1.0));
        #endregion
    }
}
